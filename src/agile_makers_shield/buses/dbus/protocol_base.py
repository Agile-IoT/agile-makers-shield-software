...
class ProtocolException(dbus.DBusException):
   ...
   def __init__(self, protocol_name, msg=""):
      if msg == "":
         ...
         super().__init__(msg)
      self._dbus_error_name = db_cons.BUS_NAME["Protocol"] + "." + protocol_name
...
class ProtocolObj(dbus.service.Object):
   ...
   @dbus.service.method(db_cons.BUS_NAME["Protocol"], in_signature="", out_signature="b")
   def Connected(self):
      return _getConnected()

   @dbus.service.method(db_cons.BUS_NAME["Protocol"], in_signature="", out_signature="s")
   def Driver(self):
      return "No driver."
   ...
   @dbus.service.method(db_cons.BUS_NAME["Protocol"], in_signature="sa{sv}", out_signature="")
...
class Protocol():
   ...
   def __init__(self):
      ...
      self._name = dbus.service.BusName(db_cons.BUS_NAME["Protocol"], dbus.SessionBus())
# -----------------------
